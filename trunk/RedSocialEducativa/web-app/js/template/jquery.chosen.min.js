/* Chosen v0.12.1 | (c) 2011-2013 by Harvest | MIT License, https://github.com/harvesthq/chosen/blob/master/LICENSE.md */ ! function() {
    var SelectParser;
...
function() {
    ...
    a = this, AbstractChosen = function() {
        ...
        return AbstractChosen.prototype.set_default_values = function() {
            ...
            var b, c, d, e, f;
            for (b = "", f = this.results_data, d = 0, e = f.length; e > d; d++) c = f[d], c.group && c.search_match ? b += this.result_add_group(c) : !c.empty && c.search_match && (b += this.result_add_option(c)), (null != a ? a.first : void 0) && (c.selected && this.is_multiple ? this.choice_build(c) : c.selected && !this.is_multiple && this.single_set_selected_text(c.text));
            return b
            ...
            for (this.no_results_clear(), f = 0, g = this.get_search_text(), e = this.search_contains ? "" : "^", d = new RegExp(e + g.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), j = new RegExp(g.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), o = this.results_data, k = 0, m = o.length; m > k; k++)
                if (a = o[k], !a.empty)
                    if (a.group) a.search_match = !1;
                    else {
                        if (a.search_match = !1, d.test(a.html)) a.search_match = !0, f += 1;
                        else if (this.enable_split_word_search && (a.html.indexOf(" ") >= 0 || 0 === a.html.indexOf("[")) && (c = a.html.replace(/\[|\]/g, "").split(" "), c.length))
                            for (l = 0, n = c.length; n > l; l++) b = c[l], d.test(b) && (a.search_match = !0, f += 1);
...
function() {
    ...
    b = this, a = jQuery, a.fn.extend({
        ...
        return e(Chosen, d), Chosen.prototype.setup = function() {
            ...
            var b, c;
            return this.container_id = this.form_field.id.length ? this.form_field.id.replace(/[^\w]/g, "_") : this.generate_field_id(), this.container_id += "_chzn", b = ["chzn-container"], b.push("chzn-container-" + (this.is_multiple ? "multi" : "single")), this.inherit_select_classes && this.form_field.className && b.push(this.form_field.className), this.is_rtl && b.push("chzn-rtl"), c = {
            ...
            var b, c, d, e;
            return this.result_highlight ? (b = this.result_highlight, c = b.attr("id"), this.result_clear_highlight(), this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("liszt:maxselected", {
                chosen: this
            }), !1) : (this.is_multiple ? b.removeClass("active-result") : (this.search_results.find(".result-selected").removeClass("result-selected"), this.result_single_selected = b), b.addClass("result-selected"), e = c.substr(c.lastIndexOf("_") + 1), d = this.results_data[e], d.selected = !0, this.form_field.options[d.options_index].selected = !0, this.selected_option_count = null, this.is_multiple ? this.choice_build(d) : this.single_set_selected_text(d.text), (a.metaKey || a.ctrlKey) && this.is_multiple || this.results_hide(), this.search_field.val(""), (this.is_multiple || this.form_field.selectedIndex !== this.current_selectedIndex) && this.form_field_jq.trigger("change", {
            ...
            var c, d;
            return d = this.results_data[b], this.form_field.options[d.options_index].disabled ? !1 : (d.selected = !1, this.form_field.options[d.options_index].selected = !1, this.selected_option_count = null, c = a("#" + this.container_id + "_o_" + b), c.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.results_showing && this.winnow_results(), this.form_field_jq.trigger("change", {
            ...
            if (this.is_multiple) {
                ...
                return b = a("<div />", {
                    style: e
                }), b.text(this.search_field.val()), a("body").append(b), g = b.width() + 25, b.remove(), this.f_width || (this.f_width = this.container.outerWidth()), g > this.f_width - 10 && (g = this.f_width - 10), this.search_field.css({
                    width: g + "px"
                })
            }
