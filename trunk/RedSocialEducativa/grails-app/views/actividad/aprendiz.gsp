	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" controller="curso" action="actividades" params="['cursoId': params.cursoId, 
		...
		<div>
			<hr>
			<h2><g:link controller="materialActividad" action="aprendiz" params="['cursoId': params.cursoId, 
					'cuatrimestreId': params.cuatrimestreId, 'actividadId': params.actividadId]">
				<g:message code="Material de la actividad"/></g:link></h2>
		</div>
		<div>
			<hr>
			<h2><g:link controller="temaActividad" action="aprendiz" params="['cursoId': params.cursoId, 'cuatrimestreId': params.cuatrimestreId, 
					'actividadId': params.actividadId]">
				<g:message code="Temas asociados con la actividad"/></g:link></h2>
		</div>
		<div>
		
				<li><g:link class="list" action="menuAprendiz" controller="grupoActividad" params="['cursoId': params.cursoId, 
						'cuatrimestreId': params.cuatrimestreId, 'actividadId': params.actividadId]">
