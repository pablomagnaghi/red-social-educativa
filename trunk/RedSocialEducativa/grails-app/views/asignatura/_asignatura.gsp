<div class="box-header" data-original-title="">
	<h2><i class="icon-table"></i><span class="break"></span>Asignatura ${asignaturaInstance}</h2>
	<div class="box-icon">
...
<div class="box-content">
	<dl>
		...
		<dt>Contenidos Minimos: </dt>
    		<dd><div class="message" style="width:100%">${fieldValue(bean: asignaturaInstance, field: "contenidosMinimos")}</div></dd>
		<dt>Cursos:</dt>
