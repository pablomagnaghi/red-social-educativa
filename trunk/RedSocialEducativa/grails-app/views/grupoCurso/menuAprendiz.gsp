	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="create" action="crear" params="['cursoId': params.cursoId, 'cuatrimestreId': params.cuatrimestreId]">
	...
	<tbody>
		<g:each in="${aprendizInstanceList}" status="i" var="aprendizInstance">
			<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
				...
				<td><g:link action="muestraAprendiz" id="${aprendizInstance.grupo.id}" 
