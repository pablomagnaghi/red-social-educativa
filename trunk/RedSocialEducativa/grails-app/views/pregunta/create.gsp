...
<html>
	...
	<body>
		<a href="#create-pregunta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-pregunta" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:preguntaInstance, action:'save']" >
				<fieldset class="form">
