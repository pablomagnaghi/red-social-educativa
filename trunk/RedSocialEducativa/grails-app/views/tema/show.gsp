			...
			<ol class="property-list tema">
				...
				<li class="fieldcontain">
					<span id="curso-label" class="property-label"><g:message code="tema.curso.label" default="Curso" /></span>
						...
						<span class="property-value" aria-labelledby="curso-label"><g:link controller="curso" action="show" id="${temaInstance?.curso?.id}">${temaInstance?.curso?.encodeAsHTML()}</g:link></span>
