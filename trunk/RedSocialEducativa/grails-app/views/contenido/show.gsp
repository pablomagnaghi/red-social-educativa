		...
		<div id="show-contenido" class="content scaffold-show" role="main">
			...
			<ol class="property-list contenido">
				...
				<li class="fieldcontain">
					<span id="materiales-label" class="property-label"><g:message code="contenido.materiales.label" default="Materiales" /></span>
					
						<g:each in="${contenidoInstance.materiales}" var="m">
						<span class="property-value" aria-labelledby="materiales-label"><g:link controller="materialContenido" action="show" id="${m.id}">${m?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="tema-label" class="property-label"><g:message code="contenido.tema.label" default="Tema" /></span>
						...
						<span class="property-value" aria-labelledby="tema-label"><g:link controller="tema" action="show" id="${contenidoInstance?.tema?.id}">${contenidoInstance?.tema?.encodeAsHTML()}</g:link></span>
			...
			<g:form url="[resource:contenidoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${contenidoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
