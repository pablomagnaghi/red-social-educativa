			...
			<div class="form-group">
				<label class="control-label span" style="width: 33px;"><strong>Para</strong></label>
					<div class="span" style="margin-top: 3px;">
						<g:if test="${para != null }">
							<input type='hidden' id="e6" style="width: 600px" name="para" value="${para }"/>
						</g:if>
						<g:else>
							<input type='hidden' id="e6" style="width: 600px" name="para" />
						</g:else>
					</div>
		...
		<div class="row" style="height: 40px;">
			<div class="form-group">
				...
				<g:if test="${asunto != null }">
					<input type="text" style="padding-top: 0px;" name="asunto" id="asunto" placeholder="Asunto del mensaje" class="form-control" value="${asunto }">
				</g:if>
				<g:else>
					<input type="text" style="padding-top: 0px;" name="asunto" id="asunto" placeholder="Asunto del mensaje" class="form-control">
				</g:else>					
				</div>
			</div>
		</div>	
