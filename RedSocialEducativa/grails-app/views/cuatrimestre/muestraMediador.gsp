	...
	<body>
		...
		<div id="show-cuatrimestre" class="content scaffold-show" role="main">
			...
			<ol class="property-list cuatrimestre">
				...
				<li class="fieldcontain">
					<span id="actividades-label" class="property-label">
						<g:message code="cuatrimestre.actividades.label" default="Actividades" /></span>
					<g:each in="${cuatrimestreInstance.actividades}" var="a">
						<span class="property-value" aria-labelledby="actividades-label">
						<g:link controller="actividad" action="show" id="${a.id}">${a?.encodeAsHTML()}</g:link></span>
					</g:each>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="foro-label" class="property-label">
						<g:message code="cuatrimestre.foro.label" default="Foro" /></span>
					<span class="property-value" aria-labelledby="foro-label">
						<g:link controller="foroCurso" action="show" id="${cuatrimestreInstance?.foro?.id}">
				...
				<li class="fieldcontain">
					<span id="grupos-label" class="property-label">
						<g:message code="cuatrimestre.grupos.label" default="Grupos" /></span>
					<g:each in="${cuatrimestreInstance.grupos}" var="g">
						<span class="property-value" aria-labelledby="grupos-label">
							<g:link controller="grupoCurso" action="show" id="${g.id}">${g?.encodeAsHTML()}</g:link></span>
					</g:each>
				</li>
				</g:if>
				...
				<li class="fieldcontain">
					<span id="noticiasCurso-label" class="property-label">
						<g:message code="cuatrimestre.noticiasCurso.label" default="Noticias Curso" /></span>
					<g:each in="${cuatrimestreInstance.noticiasCurso}" var="n">
						<span class="property-value" aria-labelledby="noticiasCurso-label">
							<g:link controller="noticiaCurso" action="show" id="${n.id}">${n?.encodeAsHTML()}</g:link></span>
					</g:each>
				</li>
				</g:if>
			...
			<g:form url="[resource:cuatrimestreInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${cuatrimestreInstance}">
