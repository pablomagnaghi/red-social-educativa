...
<g:if test="${!hasErrors(bean: asignaturaInstance, field: 'codigo', 'error')}">
	<div class="control-group">
		...
		<div class="controls"><g:textField name="codigo" value="${asignaturaInstance?.codigo}"/></div>	
	</div>	
</g:if>
<g:else>
	<div class="control-group error">
		...
		<div class="controls">
			...
			<span class="help-inline"><g:renderErrors bean="${asignaturaInstance}" as="list" field="codigo"/></span>
		</div>	
	</div>	 
</g:else>
<!-- NOMBRE -->
<g:if test="${!hasErrors(bean: asignaturaInstance, field: 'nombre', 'error')}">
	<div class="control-group">
		...
		<div class="controls"><g:textField name="nombre" value="${asignaturaInstance?.nombre}"/></div>	
	</div>	
</g:if>
<g:else>
	<div class="control-group error">
		...
		<div class="controls">
			...
			<span class="help-inline"><g:renderErrors bean="${asignaturaInstance}" as="list" field="nombre"/></span>
		</div>	
	</div>	 
</g:else>
<!-- CREDITOS -->
<g:if test="${!hasErrors(bean: asignaturaInstance, field: 'creditos', 'error')}">
	<div class="control-group">
		...
		<div class="controls"><g:textField name="creditos" value="${asignaturaInstance?.creditos}"/></div>	
	</div>	
</g:if>
<g:else>
	<div class="control-group error">
		...
		<div class="controls">
			...
			<span class="help-inline"><g:renderErrors bean="${asignaturaInstance}" as="list" field="creditos"/></span>
		</div>	
	</div>	 
</g:else>
<!-- CONTENIDOS MINIMOS -->
<g:if test="${!hasErrors(bean: asignaturaInstance, field: 'contenidosMinimos', 'error')}">
	<div class="control-group">
		...
		<div class="controls"><g:textArea name="contenidosMinimos" value="${asignaturaInstance?.contenidosMinimos}" style='width: 90%; height: 200px;'/></div>	
	</div>	
</g:if>
<g:else>
	<div class="control-group error">
		...
		<div class="controls">
			...
			<span class="help-inline"><g:renderErrors bean="${asignaturaInstance}" as="list" field="contenidosMinimos"/></span>
		</div>
	</div>	 
</g:else>
