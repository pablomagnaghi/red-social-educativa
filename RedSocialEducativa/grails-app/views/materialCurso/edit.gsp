...
<html>
	...
	<body>
		<a href="#edit-materialCurso" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-materialCurso" class="content scaffold-edit" role="main">
			...
			<g:form action="update" method="PUT" id="${materialCursoInstance.id}" params="['cursoId': params.cursoId]" >
