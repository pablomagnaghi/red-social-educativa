...
<html>
	...
	<body>
		...
		<div id="show-materialTema" class="content scaffold-show" role="main">
			...
			<g:form action="delete" method="DELETE" id="${materialTemaInstance.id}" params="['cursoId': params.cursoId, 'temaId': params.temaId]">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${materialTemaInstance}"
						id="${materialTemaInstance.id}" params="['cursoId': params.cursoId, 'temaId': params.temaId]">
