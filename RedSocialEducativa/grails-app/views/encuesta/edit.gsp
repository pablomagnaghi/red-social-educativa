...
<html>
	...
	<body>
		<a href="#edit-encuesta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-encuesta" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:encuestaInstance, action:'update']" method="PUT" >
