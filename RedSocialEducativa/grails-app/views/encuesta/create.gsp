...
<html>
	...
	<body>
		<a href="#create-encuesta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-encuesta" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:encuestaInstance, action:'save']" >
				<fieldset class="form">
