	...
	<body>
		...
		<div id="show-materialGrupo" class="content scaffold-show" role="main">
			...
			<ol class="property-list materialGrupo">
				...
				<li class="fieldcontain">
					<span id="categoria-label" class="property-label"><g:message code="materialGrupo.categoria.label" default="Categoria" /></span>
					
						<span class="property-value" aria-labelledby="categoria-label"><g:link controller="categoriaMaterial" action="show" id="${materialGrupoInstance?.categoria?.id}">${materialGrupoInstance?.categoria?.encodeAsHTML()}</g:link></span>
				...
				<g:if test="${materialGrupoInstance?.grupo}">
				<li class="fieldcontain">
					<span id="grupo-label" class="property-label"><g:message code="materialGrupo.grupo.label" default="Grupo" /></span>
					
						<span class="property-value" aria-labelledby="grupo-label"><g:link controller="grupoCurso" action="show" id="${materialGrupoInstance?.grupo?.id}">${materialGrupoInstance?.grupo?.encodeAsHTML()}</g:link></span>
			...
			<g:form url="[resource:materialGrupoInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${materialGrupoInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
