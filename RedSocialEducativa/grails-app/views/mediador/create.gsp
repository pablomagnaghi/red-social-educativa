...
<html>
	...
	<body>
		<a href="#create-mediador" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-mediador" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:mediadorInstance, action:'save']" >
				<fieldset class="form">
