...
<html>
	...
	<body>
		<a href="#edit-pregunta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-pregunta" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:preguntaInstance, action:'update']" method="PUT" >
