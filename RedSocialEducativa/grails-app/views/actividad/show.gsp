	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index" params="['cuatrimestreId': cuatrimestreId]">
		...
		<div id="show-actividad" class="content scaffold-show" role="main">
				...
				<li class="fieldcontain">
					<span id="grupos-label" class="property-label"><g:message code="actividad.grupos.label" default="Grupos" /></span>
						<span class="property-value" aria-labelledby="grupos-label">
							...
							params="['cuatrimestreId': cuatrimestreId, 'actividadId': actividadInstance.id]">Ver grupos</g:link></span>
					...
					<span id="materiales-label" class="property-label"><g:message code="actividad.materiales.label" default="Materiales" /></span>
						...
						<span class="property-value" aria-labelledby="materiales-label">
							<g:link controller="materialActividad" action="show" id="${m.id}" 
								params="['cuatrimestreId': cuatrimestreId, 'actividadId': actividadInstance.id]">${m?.encodeAsHTML()}</g:link></span>
						</g:each>
				</li>
				</g:if>
			...
			<g:form action="delete" method="DELETE" id="${actividadInstance.id}" params="['cuatrimestreId': cuatrimestreId]">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${actividadInstance}"
						id="${actividadInstance.id}" params="['cuatrimestreId': cuatrimestreId]">
