    ...
    <div class="box span12">
        <div class="box-header" data-original-title="">
            <h2><i class="icon-table"></i>
                <span class="break"></span>Actividades de ${usuario.padron} - ${usuario.nombres} ${usuario.apellido} 
                	en el cuatrimestre ${com.cursado.Cuatrimestre.get(params.cuatrimestreId)}</h2>
        </div>
