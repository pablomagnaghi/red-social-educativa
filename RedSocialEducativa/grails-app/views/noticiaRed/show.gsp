...
<html>
	...
	<body>
		...
		<div id="show-noticiaRed" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:noticiaRedInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${noticiaRedInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
